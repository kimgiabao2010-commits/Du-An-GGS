...
exports.default = SiemDashboard;
const IdeAgentSidebar_1 = __importDefault(require("../../components/IdeAgentSidebar"));
const ChartsGroup_1 = __importDefault(require("../../components/ChartsGroup"));
const CliAgentTerminal_1 = __importDefault(require("../../components/CliAgentTerminal"));
const link_1 = __importDefault(require("next/link"));
const lucide_react_1 = require("lucide-react");
function SiemDashboard() {
    return (<div style={{ display: 'flex', height: '100vh', width: '100vw', backgroundColor: 'transparent', color: 'var(--text-primary)', overflow: 'hidden', padding: '24px', gap: '24px' }}>
      ...
      <div className="vision-panel hide-scrollbar" style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '36px 40px', overflowY: 'auto' }}>
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
          <div>
              <h1 className="text-gradient" style={{ fontSize: '2rem', fontWeight: 700, letterSpacing: '0.5px', margin: 0, display: 'flex', alignItems: 'center', gap: '14px' }}>
                  <div style={{ background: 'rgba(10, 132, 255, 0.15)', padding: '8px', borderRadius: '14px', border: '1px solid rgba(10, 132, 255, 0.3)', display: 'flex' }}>
                    <lucide_react_1.Shield size={28} color="var(--accent-neon)"/> 
                  </div>
                  SOC DASHBOARD
              </h1>
          ...
          <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
              ...
              <link_1.default href="/" className="nav-btn" style={{ width: 'auto', padding: '12px 24px', background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
                ⬅ Về Chỉ Huy
              </link_1.default>
          </div>
        </header>
